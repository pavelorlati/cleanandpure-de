...
const features = [
  { icon: Heart, label: "Mit Herz & Leidenschaft" },
    ...
    <div className="mx-auto max-w-[1400px] px-6">
      <div className="grid lg:grid-cols-2 gap-16 items-center">
        <div className="space-y-6">
          <p className="text-sm font-medium text-primary tracking-[0.2em] uppercase">Über uns</p>
        ...
        <div className="grid grid-cols-2 gap-6">
          {features.map((f) => (
            <div key={f.label} className="bg-muted rounded-xl p-8 text-center space-y-4">
