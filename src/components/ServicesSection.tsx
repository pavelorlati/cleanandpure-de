...
const ServicesSection = () => (
  <section id="services" className="bg-background">
    ...
    {/* List */}
    <div className="max-w-6xl mr-auto pl-6 md:pl-12 lg:pl-20 pr-6 pb-20 border-t border-border">
      {services.map((s) => (
        <article
          key={s.title}
    ...
    {/* CTA */}
    <div className="max-w-6xl mr-auto pl-6 md:pl-12 lg:pl-20 pr-6 pb-24">
