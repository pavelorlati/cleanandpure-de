...
const why = [
  ...
  { n: "04", title: "Persönlicher Service", desc: "Direkte Ansprechpartner*in, kurze Wege und ein offenes Ohr für Ihre Wünsche." },
];
    ...
    <main className="flex-1">
      ...
      <section className="py-24 md:py-32">
        <div className="container-x">
          ...
          <div className="grid md:grid-cols-3 gap-6 mt-16 md:h-[560px]">
            <div className="md:col-span-2 relative h-72 md:h-full overflow-hidden rounded-sm" data-reveal="left">
            ...
            <div className="grid grid-rows-2 gap-6 md:h-full">
