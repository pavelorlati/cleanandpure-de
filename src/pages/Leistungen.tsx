          ...
          {services.map((s, i) => (
            ...
            >
              ...
              <div className="overflow-hidden rounded-sm bg-secondary/50">
                <img src={s.img} alt={s.title} className={`w-full h-40 transition-transform duration-700 ease-out group-hover:scale-[1.04] ${s.n === "07" ? "object-contain" : "object-cover"}`} loading="lazy" />
              </div>
              <div>
