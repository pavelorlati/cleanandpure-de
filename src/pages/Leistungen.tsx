          ...
          {services.map((s, i) => (
            ...
            >
              ...
              <div className="overflow-hidden rounded-sm bg-secondary/50 h-40">
                <img src={s.img} alt={s.title} className={`w-full h-full object-cover transition-transform duration-700 ease-out group-hover:scale-[1.04] ${s.n === "07" ? "object-bottom" : ""}`} loading="lazy" />
              </div>
              <div>
