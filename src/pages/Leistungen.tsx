        ...
        <div className="container-x">
          {services.map((s, i) => (
            ...
            >
              ...
              <div className={`overflow-hidden rounded-sm bg-secondary/50 ${s.n === "07" ? "aspect-[3/4]" : "h-40"}`}>
                <img src={s.img} alt={s.title} className="w-full h-full object-cover transition-transform duration-700 ease-out group-hover:scale-[1.04]" loading="lazy" />
              </div>
              <div>
